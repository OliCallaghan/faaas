...
file_path = 'tpch-q1-resp-times.json'
...
df['duration'].plot(kind='hist', bins=15, edgecolor='black', ax=ax, density=True, label="TCP-H Query 1")
...
plt.title('TPC-H query 1 response time\ndistribution from AWS Lambda')
plt.savefig("assets/tpch-q1-resp-times.pgf", bbox_inches="tight")
