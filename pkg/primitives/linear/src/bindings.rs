...
pub fn task_fst(ctx: TaskContext) -> Result<TaskContext, TaskError> {
    unsafe {
        #[repr(align(4))]
...
#[allow(unused_unsafe, clippy::all)]
pub fn task_snd(ctx: TaskContext) -> Result<TaskContext, TaskError> {
    unsafe {
        #[repr(align(4))]
        struct RetArea([::core::mem::MaybeUninit<u8>; 8]);
        let mut ret_area = RetArea([::core::mem::MaybeUninit::uninit(); 8]);
...
A\x0e\x01B\x10\x04\0\x0ctask-context\x03\x01\x01m\x03\x07unknown\x07success\x05e\
...
\x05\x01\x06\x01@\x01\x03ctx\x05\0\x07\x03\0\x08task-fst\x01\x08\x03\0\x08task-s\
nd\x01\x08\x01B\x09\x02\x03\x02\x01\x01\x04\0\x0ctask-context\x03\0\0\x02\x03\x02\
\x01\x03\x04\0\x0atask-error\x03\0\x02\x01i\x01\x01i\x03\x01j\x01\x04\x01\x05\x01\
@\x01\x03ctx\x04\0\x06\x04\0\x04call\x01\x07\x04\x01\x13faaas:task/callable\x05\x09\
\x04\x01\x13faaas:linear/linear\x04\0\x0b\x0c\x01\0\x06linear\x03\0\0\0G\x09prod\
