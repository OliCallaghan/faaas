...
pub fn task_condition(ctx: TaskContext) -> Result<TaskContext, TaskError> {
    unsafe {
        #[repr(align(4))]
        ...
        wit_import((&ctx).take_handle() as i32, ptr0);
        ...
        match l1 {
            0 => {
                let e = {
                    ...
                    faaas::task::types::TaskContext::from_handle(l2 as u32)
                };
                Ok(e)
            }
            1 => {
...
#[allow(unused_unsafe, clippy::all)]
pub fn task_branch_true(ctx: TaskContext) -> Result<TaskContext, TaskError> {
    unsafe {
        #[repr(align(4))]
        struct RetArea([::core::mem::MaybeUninit<u8>; 8]);
        let mut ret_area = RetArea([::core::mem::MaybeUninit::uninit(); 8]);
...
#[allow(unused_unsafe, clippy::all)]
pub fn task_branch_false(ctx: TaskContext) -> Result<TaskContext, TaskError> {
    unsafe {
        #[repr(align(4))]
        struct RetArea([::core::mem::MaybeUninit<u8>; 8]);
        let mut ret_area = RetArea([::core::mem::MaybeUninit::uninit(); 8]);
...
A\x0f\x01B\x10\x04\0\x0ctask-context\x03\x01\x01m\x03\x07unknown\x07success\x05e\
...
faaas:task/types\x05\0\x02\x03\0\0\x0ctask-context\x03\0\x0ctask-context\x03\0\x01\
\x02\x03\0\0\x0atask-error\x03\0\x0atask-error\x03\0\x03\x01i\x02\x01i\x04\x01j\x01\
\x05\x01\x06\x01@\x01\x03ctx\x05\0\x07\x03\0\x0etask-condition\x01\x08\x03\0\x10\
task-branch-true\x01\x08\x03\0\x11task-branch-false\x01\x08\x01B\x09\x02\x03\x02\
\x01\x01\x04\0\x0ctask-context\x03\0\0\x02\x03\x02\x01\x03\x04\0\x0atask-error\x03\
\0\x02\x01i\x01\x01i\x03\x01j\x01\x04\x01\x05\x01@\x01\x03ctx\x04\0\x06\x04\0\x04\
call\x01\x07\x04\x01\x13faaas:task/callable\x05\x09\x04\x01\x19faaas:condition/c\
ondition\x04\0\x0b\x0f\x01\0\x09condition\x03\0\0\0G\x09producers\x01\x0cprocess\
